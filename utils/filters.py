...
def apply_filters(df: pd.DataFrame) -> pd.DataFrame:
    ...
    with st.sidebar:
        ...
        st.markdown('<hr style="border-color:#2D3F55;margin:8px 0 16px 0;">', unsafe_allow_html=True)

        # ── Date range ──────────────────────────────────────────────────
        st.markdown('<p style="font-size:11px;color:#94A3B8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">Date Range</p>', unsafe_allow_html=True)
        ...
        st.markdown('<p style="font-size:11px;color:#94A3B8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">City</p>', unsafe_allow_html=True)
        ...
        # ── Product ─────────────────────────────────────────────────────
        st.markdown('<hr style="border-color:#2D3F55;margin:12px 0;">', unsafe_allow_html=True)
        st.markdown('<p style="font-size:11px;color:#94A3B8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">Product</p>', unsafe_allow_html=True)
        ...
        # ── Customer Tier ────────────────────────────────────────────────
        st.markdown('<hr style="border-color:#2D3F55;margin:12px 0;">', unsafe_allow_html=True)
        st.markdown('<p style="font-size:11px;color:#94A3B8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">Customer Tier</p>', unsafe_allow_html=True)
        ...
        # ── Trip Purpose ─────────────────────────────────────────────────
        st.markdown('<hr style="border-color:#2D3F55;margin:12px 0;">', unsafe_allow_html=True)
        st.markdown('<p style="font-size:11px;color:#94A3B8;font-weight:600;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">Trip Purpose</p>', unsafe_allow_html=True)
        ...
        # ── Dataset info ──────────────────────────────────────────────────
        st.markdown('<hr style="border-color:#2D3F55;margin:16px 0 8px 0;">', unsafe_allow_html=True)
        st.markdown(
            '<p style="font-size:10px;color:#475569;line-height:1.6;">'
            '📊 500,000 ride records<br>'
            '🏙️ Dubai · Abu Dhabi · Riyadh · Jeddah · Cairo<br>'
            '📅 Jan – Dec 2025<br>'
